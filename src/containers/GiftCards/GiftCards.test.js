...
import { GiftCards, mapStateToProps, changeText, toggleDebunksDisplay, addPicToPrint, printOut } from './GiftCards';
import { addDebunks } from '../../actions/index.js';

describe('GiftCards container', () => {
  let initial;
  let expected;
  let wrapper;

  describe('GiftCards component', () => {
    wrapper = shallow(<GiftCards />);
    ...
    it('should invoke changeText when change-text button is clicked', () => {
      ...
      wrapper = mount(<GiftCards changeText={changeTextMock}/>)
